...
public class ConsultarBD_01_20022024 extends JFrame implements ActionListener{
	...
	lblImpTxtForEach, lblLimpaTexto, lblBancoConectado, lblBancoDesconectado, lblConsultarBD, lblPreferencias, lblPreferenciasgd;
	...
	public void init() {
		...
		lstbxPreferencias.setBounds(lblMensagem.getX()+220, lblMensagem.getY()+15, lblMensagem.getWidth()+275, lblMensagem.getHeight()+350);
		add(lstbxPreferencias);
		
		lblPreferenciasgd = new JLabel("dtgdvwPreferencias");
		lblPreferenciasgd.setSize(lblMensagem.getWidth(),lblMensagem.getHeight());
		lblPreferenciasgd.setLocation(lblMensagem.getX()+220, lstbxPreferencias.getY()+370);
		add(lblPreferenciasgd);
		
		dtgdvwPreferencias = new JPanel(new BorderLayout());
        dtgdvwPreferencias.setSize(lblMensagem.getWidth()+280,lblMensagem.getHeight()+225);
        dtgdvwPreferencias.setLocation(lblMensagem.getX()+220,lblMensagem.getY()+410);  
	...
	public void ConsultarBD() {
		...
		try {
            ...
            while (rsPreferencias.next()) {
                modelo.addRow(new Object[]{rsPreferencias.getString("Descricao")});
            }
            ...
            dtgdvwPreferencias.add(new JScrollPane(table), BorderLayout.CENTER);
